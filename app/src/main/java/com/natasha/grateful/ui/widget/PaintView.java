...
package com.natasha.grateful.ui.widget;

import com.natasha.grateful.ui.widget.Progress;
import com.natasha.grateful.util.FloodFill;
import com.natasha.grateful.util.DrawUtils;
import java.io.File;
...
public class PaintView extends View
{
    ...
    public void sErase(Boolean isErase) {


        erase=isErase;
      //reload same image
       _state._paintedBitmap.eraseColor(Color.WHITE);
        erase=false;
    }
